...
#var path = []
#
#func setMoveTarget(movementTarget: Vector3):
...
#		return
#
#	var current_agent_position = global_transform.origin
#	var next_path_position = navAgent.get_next_path_position()
#
#	var newVelocity: Vector3 = next_path_position - current_agent_position
